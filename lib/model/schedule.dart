class Schedule {
  ...
  static List<Schedule> scheduleMonday() {
    final _scheduleList = <Schedule>[
      ...
      Schedule('03:00', 'Музыка', ''),
      Schedule('04:00', 'Музыка', ''),
      Schedule('05:00', 'Формула семьи (повтор)', ''),
      Schedule('06:00', 'Музыка', ''),
      Schedule('07:40', '"Жашоонун негиздери"', ''),
      Schedule('08:00', '"Кутман таң" шоу-уктуруусу', ''),
      Schedule('09:00', '"Кутман таң" шоу-уктуруусу', ''),
      Schedule('10:00', '"День добрый"', ''),
      Schedule('11:00', '"День добрый"', ''),
      Schedule('12:00', 'DJ сааты', ''),
      Schedule('12:30', 'DJ сааты', ''),
      Schedule('13:00', 'DJ сааты', ''),
      Schedule('14:00', 'DJ сааты', ''),
      Schedule('15:00', 'DJ сааты', ''),
      Schedule('16:00', 'DJ сааты', ''),
      Schedule('17:00', 'DJ сааты', ''),
      Schedule('18:00', 'Иммунитет', ''),
      Schedule('19:00', 'Музыка', ''),
      Schedule('20:00', 'Формула семьи', ''),
      Schedule('21:00', 'Час Классической музыки', ''),
      Schedule('22:00', '"День добрый" (повтор)', ''),
      Schedule('23:00', '"День добрый" (повтор)', ''),
    ];
  ...
  static List<Schedule> scheduleFriday() {
    final _scheduleList = <Schedule>[
      ...
      Schedule('08:00', '"Кутман таң" шоу-уктуруусу', ''),
      Schedule('09:00', '"Кутман таң" шоу-уктуруусу', ''),
      Schedule('10:00', '"День добрый" (повтор)', ''),
      Schedule('11:00', '"День добрый" (повтор)', ''),
      Schedule('12:00', 'DJ сааты', ''),
  ...
  static List<Schedule> scheduleSaturday() {
    final _scheduleList = <Schedule>[
      Schedule('00:00', 'Музыка', ''),
      Schedule('01:00', 'Музыка', ''),
      Schedule('02:00', 'Музыка', ''),
      Schedule('03:00', 'Музыка', ''),
      Schedule('04:00', 'Музыка', ''),
      Schedule('05:00', 'Музыка', ''),
      Schedule('06:00', 'Музыка', ''),
      Schedule('07:40', '"Шыктаныңыз"', ''),
      Schedule('08:00', 'Музыка', ''),
      Schedule('09:00', '"Таңкы маанай" уктуруусу', ''),
      Schedule('10:00', '"Таңкы маанай" уктуруусу', ''),
      ...
      Schedule('18:00', '', ''),
      Schedule('19:00', 'Музыка', ''),
      Schedule('20:00', 'Музыка', ''),
      Schedule('21:00', 'Час Классической музыки', ''),
      Schedule('22:00', 'Музыка', ''),
      Schedule('23:00', 'Музыка', ''),
    ];
